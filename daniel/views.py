...
data = merge_inicial[['curso','id_interesse','categoria','nome_interesse','grau']]



###Analises
#fazendo a tabela relacionado idade com os interesses
data = data[['curso','nome_interesse','grau']]
...
## Graficos 
MAT_gb_graf.plot(kind='barh',figsize=(9,12), color="orange")
...
CD_gb_graf.plot(kind='barh',figsize=(9,12), color="blue")
plt.xlabel('Nivel de interesse')
plt.ylabel('Interesses')
...
data_soma_interesse_graf.plot(kind='barh',figsize=(9,15), color="turquoise")
plt.xlabel('Nivel de interesse')
plt.ylabel('Interesses')
...
CD_MAT_graf[['grau_CD','grau_MAT']].plot(figsize=(9,12),kind='barh')
plt.xlabel('Nivel de interesse')
plt.ylabel('Interesses')
plt.title('Visão geral dos interesses dos alunos de CD', loc='left')
plt.legend()
